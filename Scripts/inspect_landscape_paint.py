...
views=[('LandscapePaintTown',(160,-65,50),35,-32),('LandscapePaintFarm',(102,-191,29),-73,-23)]
def tick(dt):
 global stage,start
 w=u.find_object(None,'/Game/Conservatory/Maps/L_LandscapePaintStudy.L_LandscapePaintStudy')
 if not w:return
